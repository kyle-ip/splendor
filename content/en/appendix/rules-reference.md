...
| Players | Tokens per gem color | Noble tiles |
|---------|----------------------|-------------|
| 2 | 4 | 3 (players + 1) |
| 3 | 5 | 4 |
| 4 | 7 | 5 |
...
- Prestige on development cards + noble tiles (+3 each)
...
- **Noble visits**: Cannot be refused; choose if several
- **End of game**: Finish the round
- **Competitor mode**: Assists off
- **Variants**: Cities, Trading Posts, Orient, Strongholds
