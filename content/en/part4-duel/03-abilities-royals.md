...
Icons vary by printing; the effects are:

| Effect | What happens |
|--------|----------------|
| **Extra turn** | Take another full turn immediately after this one ends |
| **Copy color** | Overlap this card on a Jewel card that already has a **bonus**. Treat this card’s bonus as that color. **You cannot buy this card** if you have no bonus card yet |
| **Take matching token** | Take 1 token of **this card’s color** from the board; ignore if none left |
...
- When you reach your **3rd** Crown, take **1 available Royal card** and resolve its ability.
- When you reach your **6th** Crown, take another available Royal card the same way.
