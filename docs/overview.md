...
Unofficial bilingual learning site for Splendor (EN / 中文).
...
6. Splendor Duel: Part V after you are comfortable with base Splendor (standalone 2-player game)

## Rules source

Base-game rules in the lessons are aligned with [`references/splendor-rulebook.pdf`](../references/splendor-rulebook.pdf) (Space Cowboys English rulebook).

## Not affiliated

Art and component imagery © Space Cowboys / Asmodee. See [`public/assets/ATTRIBUTION.md`](../public/assets/ATTRIBUTION.md).
